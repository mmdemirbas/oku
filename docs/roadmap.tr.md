...
```oku-kpi-grid
{"tiles":[{"num":"53","label":"Şemanın kabul ettiği grafik türü"},{"num":"50","label":"Grafikler sayfasında işlenmiş örneği olan tür"},{"num":"19","label":"Kataloglanmış Mermaid şema türü"},{"num":"10","label":"Grafikler sayfasındaki amaç ailesi"},{"num":"24","label":"oku check --strict altında temiz belge sayfası"},{"num":"696","label":"Pytest testi — yeşil"},{"num":"2","label":"oku build başına derleme ağacı (standalone / site)"},{"num":"10","label":"Seri renk rampası (--series-1..10)"}]}
```
